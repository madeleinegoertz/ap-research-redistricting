...
# read in files
bg = geopandas.read_file("zip://shp/ok_2018_blck_grp_shp_pop.zip")
precincts = geopandas.read_file("zip://shp/ok_2018_ushouse_precincts.zip")
# reproject files to north va CRS
precincts = precincts.to_crs(epsg=2267)
bg = bg.to_crs(epsg=2267)
...
precincts = precincts[["PRECINCT", "COUNTY", "CNTYNAME", "CNTYFIPS", "PRECODE", "USH18D", "USH18R",
"pop", "white_pop", "black_pop", "aian_pop", "asian_pop", "nhopi_pop", "sor_pop", "2more_pop", "geometry"]]

precincts = precincts.rename(columns={"USH18D":"G18HORDEM", "USH18R":"G18HORREP"})

out_file = "shp/ok_ushouse_2018_precincts_race.shp"
