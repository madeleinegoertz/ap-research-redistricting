...
# read in files
bg = geopandas.read_file("zip://shp/or_2018_blck_grp_shp_pop.zip")
precincts = geopandas.read_file("zip://shp/or_2018_ushouse_precincts.zip")
# reproject files to north va CRS
precincts = precincts.to_crs(epsg=2269)
bg = bg.to_crs(epsg=2269)
