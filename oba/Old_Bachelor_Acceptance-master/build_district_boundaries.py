...
# predefined values
maptofind = r"C:\Users\madie\ap-research-redistricting\oba\Old_Bachelor_Acceptance-master\tractinitial40.txt" # the filename of the map to create district boundaries for. each line should be "geoid,district"
